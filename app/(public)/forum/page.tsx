    ...
    <main>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-mono text-sand/70">{t(locale, "forum.categories")}</h2>
          <Link
            href="/forum/nuovo"
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {latestThread && (
                      <p className="text-xs text-sand/30 mt-2 truncate">
                        {t(locale, "forum.last")} {latestThread.title}{" "}
                        <span className="text-sand/20">
                          — {new Date(latestThread.updatedAt).toLocaleDateString(
